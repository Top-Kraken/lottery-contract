 ...
 */
contract LunaChowLottery is ReentrancyGuard, ILunaChowLottery, Ownable {
    ...
    function claimTickets(
        ...
        for (uint256 i = 0; i < _ticketIds.length; i++) {
            ...
            rewardInLuchowToTransfer += rewardForTicketId;
        }
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInLuchow >= minPriceTicketInLuchow) && (_priceTicketInLuchow <= maxPriceTicketInLuchow),
            "Outside of limits"
        );
     ...
     */
    function setMinAndMaxTicketPriceInLuchow(uint256 _minPriceTicketInLuchow, uint256 _maxPriceTicketInLuchow)
        external
        onlyOwner
    {
        require(_minPriceTicketInLuchow <= _maxPriceTicketInLuchow, "minPrice must be < maxPrice");
