...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public lunaChowLottery;
     ...
     * @param _lunaChowLottery: address of the Lottery
     */
    function setLotteryAddress(address _lunaChowLottery) external onlyOwner {
        lunaChowLottery = _lunaChowLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ILunaChowLottery(lunaChowLottery).viewCurrentLotteryId();
    }
}